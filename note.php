...
?>
<div id="content-infoname"><b>Заметка</b><div style="float: right;"><?php
echo $redach;
?></div></div>
<div id="content-wall-post">
<table style="font-size:11px;width: 620px;" border="0"><tbody><tr><td style="width:54px;vertical-align:top;">
   <div id="content-wall-post-avatar"><img id="avatar" src="<?php
echo $avatar;
?>" width="50"></div></td><td style="width:345px;vertical-align:0;">
     <div id="content-wall-post-infoofpost">
      
      <div id="content-wall-post-authorofpost"><text style="margin-right: 3px;"><b><a href="id<?php
echo $mynote[ 'id' ];
?>"><?php
echo $mynote[ 'name' ] . ' ' . $mynote[ 'surname' ];
?></a></b></text><br><div id="content-date"><?php
echo zmdate( $notes[ 'date' ] );
?></div></div>
     
     <div id="content-wall-post-text" style="width:550px;" class="note"><h4><?php
echo $notes[ 'name' ] . $redachstatus;
?></h4><p><?php
echo $notes[ 'text' ];
?></p></div>
...
<script type="text/javascript">
  ...
  function openWindowsQ(){
    WindowsQ = $.window({
   title: "Подтверждение",
   content: '<div style="padding:10px; font-size:11px;"><center>Вы действительно хотите удалить заметку?</center><br><center><a href="delete_note.php?id=<?php
echo $_GET[ 'id' ];
