...
<a href="messages.php?id=<?php
        echo $im1[ 'id' ];
?>" class="im">
<div class="im-mess<?php
        echo $redit;
?>" style="padding:15px;margin:0 -10px;">
<table border="0" style="font-size:11px;">
<tr>
<td style="width:54px;"><img src="<?php
        echo $avatar;
...
?></div>
<td style="padding-left:10px;"><b style="font-size:14px;"><?php
        echo $user[ 'name' ] . ' ' . $user[ 'surname' ];
?></b><br><div style="margin-top:8px;"></div>
<?php
        echo $im1[ 'text' ];
?>
</td>
...
<td style="padding-left:10px;"><b style="font-size:14px;"><?php
        echo $user[ 'name' ] . ' ' . $user[ 'surname' ];
?></b><br><div style="margin-top:8px;"></div>
<text style="padding-right:5px;color:#8b939b;">Вы:</text><?php
        echo $im2[ 'text' ];
?>
</td>
</tr>
        ...
        <td>
          <table>
            <tr>
              ...
              <td style="font-size: 11px;">
                <?php
    echo '<a href="id' . $user[ 'id' ] . '">' . $user[ 'name' ] . ' ' . $user[ 'surname' ] . '</a>';
?>
              </td>
            </tr>
            <tr>
