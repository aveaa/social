...
?>
   ...
   <b>Добро пожаловать в l-lacker Social</b> (на основе OpenVK).<br><br>
   Этот сайт создан для быстрой связи с друзьями, одноклассниками и однокурсниками,
   а также ностальгии о старом ВК.<br><br>
   <?php
...
?>
   Уже написано <b>5,000+</b> строчек кода и зарегистрированно <b><?php
echo $userscouunt;
?></b>.<br><br>
