...
?> » Группы</b><div style="float:right;"><?php
        if ( $id == $_SESSION[ 'id' ] )
          {
?><a href="groups.php?type=created">Управление</a>&nbsp;&nbsp;<a href="search.php?type=groups">Поиск групп</a><?php
          } //$id == $_SESSION[ 'id' ]
?></div></div>
        ...
        while ( $gr = $qs->fetch() )
          {
            ...
            elseif ( $group[ 'verify' ] == "2" )
              {
                $ver = ' <img src="img/verify_blue.png" width="12" height="12" style="margin-left:0;margin-right:0;">';
              } //$group[ 'verify' ] == "2"
            elseif ( $group[ 'verify' ] == "3" )
              {
                $ver = ' <img src="img/verify_green.png" width="12" height="12" style="margin-left:0;margin-right:0;">';
              } //$group[ 'verify' ] == "3"
            elseif ( $group[ 'verify' ] == "4" )
              {
                $ver = ' <img src="img/verify_orange.png" width="12" height="12" style="margin-left:0;margin-right:0;">';
              } //$group[ 'verify' ] == "4"
            elseif ( $group[ 'verify' ] == "5" )
              {
                $ver = ' <img src="img/verify_interes.png" width="12" height="12" style="margin-left:0;margin-right:0;">';
              } //$group[ 'verify' ] == "5"
            else
              {
                $ver = '';
...
?>
<a id="aprofile" href="groups.php?type=sub&sort_by=random&id=<?php
        echo $id;
?>">Сортировать рандомно</a>
<a id="aprofile" href="groups.php?type=sub&sort_by=date1&id=<?php
        echo $id;
?>">Сортировать по дате создания (увеличение)</a>
<a id="aprofile" href="groups.php?type=sub&sort_by=date2&id=<?php
        echo $id;
