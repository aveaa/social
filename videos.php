...
?> » Видеозаписи</b><div style="float:right;"><a href="search.php?type=videos">Поиск видеозаписей</a></div></div>
...
<br><?php
    ...
    elseif ( $vidcount == '2' OR $vidcount == '3' OR $vidcount == '4' )
      ...
      } //$vidcount == '2' OR $vidcount == '3' OR $vidcount == '4'
    else
      {
...
<a id="aprofile" href="videos.php?id=<?php
    echo $id;
?>&sort_by=random">Сортировать рандомно</a>
<a id="aprofile" href="videos.php?id=<?php
    echo $id;
?>&sort_by=date1">Сортировать по дате создания (увеличение)</a>
<a id="aprofile" href="videos.php?id=<?php
    echo $id;
?>&sort_by=date2">Сортировать по дате создания (убывание)</a>
</div>
</div>
</div>
<div>
