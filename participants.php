...
<a id="aprofile" href="participants.php?sort_by=random&id=<?php
echo $id;
?>">Сортировать рандомно</a>
<a id="aprofile" href="participants.php?sort_by=date1&id=<?php
echo $id;
?>">Сортировать по дате регистрации (увеличение)</a>
<a id="aprofile" href="participants.php?sort_by=date2&id=<?php
echo $id;
