...
?> » Встречи</b>&nbsp;&nbsp;<a href="search.php?type=groups">Поиск групп</a></div>
...
?>
<a id="aprofile" href="meetings.php?type=sub&sort_by=random&id=<?php
        echo $id;
?>">Сортировать рандомно</a>
<a id="aprofile" href="meetings.php?type=sub&sort_by=date1&id=<?php
        echo $id;
?>">Сортировать по дате создания (увеличение)</a>
<a id="aprofile" href="meetings.php?type=sub&sort_by=date2&id=<?php
        echo $id;
?>">Сортировать по дате создания (убывание)</a>
</div>
</div>
</div>
<div>
