...
<!--<a href="/feed.php">Мои новости<sup>α</sup></a>-->
<?php 
...
<a href="/club1">Разработчикам&nbsp;<sup>α</sup></a>
...
<? if($user1['groupu'] == "1" || $user1['groupu'] == "2"){ ?>
<hr><h4>Смена цвета</h4>
Для администраторов и тестеров поддерживается смена цвета в записях и комментариях. <br>
<a href="#" onclick="alert('Теги &Green &Red &Blue &Violet &Brown делают запись цветной. Тег &Close - конец цвета, т.е. закрытие тега span от цвета.');" style="opacity: 1;">Подробности</a><br><br>
<? } ?>
