...
if ( $id == '5' )
  ...
  <div class="simpleBar clearFix">
   ...
   1. Вернуться на <a href="index.php">главную</a>.<br>
...
if ( $id == '6' )
  ...
  <div class="simpleBar clearFix">
   ...
   2. А может быть, эта фотография просто стоит у элиты, и её нельзя открыть? Такие пользователи и группы у нас есть. Но как? :think:<br>
...
if ( $id == '8' )
  {
    echo '<div class="simpleBlock">
  <div class="simpleHeader">Ошибка 404</div>
  <div class="simpleBar clearFix">
   Вы захотели перейти на страницу, которой, увы, не существует... Вернитесь обратно.<br>
