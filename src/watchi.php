...
if ( $_GET[ 'image' ] == 'admin_main.php' AND $_GET[ 'image' ] == 'php' )
  {
    echo "hackers?";
    exit( );
  } //$_GET[ 'image' ] == 'admin_main.php' AND $_GET[ 'image' ] == 'php'
...
if ( isset( $_GET[ 'image' ] ) != null && is_file( $_GET[ 'image' ] ) )
  {
    $image = $_GET[ 'image' ];
  } //isset( $_GET[ 'image' ] ) != null && is_file( $_GET[ 'image' ] )
elseif ( $_GET[ 'id' ] != null )
  {
...
?>><img <?php
    echo 'src="' . $image . '"';
?> style="width:400px;height:auto;"></center></a><br><hr>
...
<tr><td style="width:150px;"><div style="float:right;padding-right:7px;color:#777;">Описание:</div></td><td><?php
        echo $photo[ 'note' ];
?></td></tr>
<?php
      } //$_GET[ 'id' ]
    ...
    if ( $photo[ 'user' ] != "" )
      {
        ...
        $author = $qss->fetch();
?>
<tr><td style="width:150px;"><div style="float:right;padding-right:7px;color:#777;">Загрузил:</div></td><td><?php
        echo '<a href="id' . $author[ 'id' ] . '">' . $author[ 'name' ] . ' ' . $author[ 'surname' ] . '</a>';
?></td></tr>
<?php
      } //$photo[ 'user' ] != ""
?>
<tr><td style="width:150px;"><div style="float:right;padding-right:7px;color:#777;">Дата создания:</div></td><td><?php
    echo zmdate( filemtime( $image ) );
?></td></tr> 
</table><br>
  </div>
  </div>
