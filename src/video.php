...
echo '<a href="id' . $bugrs[ 'id' ] . '"> ' . $bugrs[ 'name' ] . ' ' . $bugrs[ 'surname' ] . ' </a> » Видеозаписи » ' . $name;
?></b></div>
<?php
if ( $video[ 'ban' ] != "1" )
  {
?>
<div id="content-main-gray"><center><iframe width="560" height="315" <?php
    echo 'src="https://www.youtube.com/embed/' . $video_id . '" frameborder="0" allowfullscreen="allowfullscreen"';
?> frameborder="1"></iframe></center><p style="font-size: 11px;"> <?php
    echo '' . $about . '';
?></p><div style="float:right;width:200px;margin-top:-8px;">

<a href="id<?php
    echo $bugrs[ 'id' ];
?>"><?php
    echo $bugrs[ 'name' ] . ' ' . $bugrs[ 'surname' ];
?></a>
