            ...
            if ( $icc[ 'code' ] == NULL && $icc[ 'createdby' ] == NULL )
              {
                ...
                exit( );
              } //$icc[ 'code' ] == NULL && $icc[ 'createdby' ] == NULL
            if ( $icc[ 'usedby' ] != "0" )
              {
            ...
            if ( $resultcheck[ 'login' ] == $_POST[ 'reg_login' ] )
              {
                ...
                exit( );
              } //$resultcheck[ 'login' ] == $_POST[ 'reg_login' ]
            ...
            if ( $_POST[ 'reg_fname' ] == NULL || $_POST[ 'reg_lname' ] == NULL )
              {
                ...
                exit( );
              } //$_POST[ 'reg_fname' ] == NULL || $_POST[ 'reg_lname' ] == NULL
...
?>
<div id="content-infoname"><b>Как зарегистрироваться?</b></div>
<center>Социальная сеть l-lacker Social предназначена только для избранных, каждого сюда не впустят.</center>
<center>Оставьте заявку на регистрацию в <a href="https://vk.me/hackerapps">личные сообщения нашей группы обычного ВКонтакте</a>. Спасибо.</center>
<br>
</div>
</div>
</div>
