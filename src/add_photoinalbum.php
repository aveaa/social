    ...
    if ( $_SESSION[ 'id' ] != $albumcheck[ 'aid' ] )
      {
        ...
        exit( );
      } //$_SESSION[ 'id' ] != $albumcheck[ 'aid' ]
  } //$_SESSION[ 'idalbum' ] == $albumcheck[ 'id' ]
        ...
        if ( strpos( $_FILES[ 'picture' ][ 'name' ], '.jpg' ) || strpos( $_FILES[ 'picture' ][ 'name' ], '.png' ) || strpos( $_FILES[ 'picture' ][ 'name' ], '.jpeg' ) || strpos( $_FILES[ 'picture' ][ 'name' ], '.gif' || $_FILES[ 'picture' ][ 'name' ], '.JPG' ) || strpos( $_FILES[ 'picture' ][ 'name' ], '.PNG' ) || strpos( $_FILES[ 'picture' ][ 'name' ], '.JPEG' ) || strpos( $_FILES[ 'picture' ][ 'name' ], '.GIF' ) )
          {
            ...
            imagejpeg( imagecreatefromstring( file_get_contents( $path . $_FILES[ 'picture' ][ 'name' ] ) ), $path . $rand . ".jpg" );
          ...
          } //strpos( $_FILES[ 'picture' ][ 'name' ], '.jpg' ) || strpos( $_FILES[ 'picture' ][ 'name' ], '.png' ) || strpos( $_FILES[ 'picture' ][ 'name' ], '.jpeg' ) || strpos( $_FILES[ 'picture' ][ 'name' ], '.gif' || $_FILES[ 'picture' ][ 'name' ], '.JPG' ) || strpos( $_FILES[ 'picture' ][ 'name' ], '.PNG' ) || strpos( $_FILES[ 'picture' ][ 'name' ], '.JPEG' ) || strpos( $_FILES[ 'picture' ][ 'name' ], '.GIF' )
        else
          {
